...
import web.exposure_sites               # interacting with Google ads and Ad Settings
import converter.reader             # read log and create feature vectors
import analysis.statistics          # statistics for significance testing
import time

log_file = 'log.exposure.login.txt'
...
def exp_treatment(unit):
    unit.opt_in()
    unit.login_google("samanthakearney8", "samanthakea1234")
    unit.login_dailystrength("samanthakearney8", "samanthakea1234")
    unit.login_psychforums("samanthakearney8", "Samanthakea1234")
    unit.login_intherooms("samanthakearney8", "samanthakea1234")
    unit.login_addictiontribe("samanthakearney8", "samanthakea1234")
