...
import web.linkedin_jobs               # interacting with Google ads and Ad Settings
import converter.reader             # read log and create feature vectors
import analysis.statistics          # statistics for significance testing

log_file = 'log.linkedin.txt'
site_file = 'linkedin.txt'

def make_browser(unit_id, treatment_id):
    b = web.linkedin_jobs.LinkedinJobsUnit(browser='firefox', log_file=log_file, unit_id=unit_id, 
