...
# os.system("python collector/collect/run.py %s %s %s" % (AD_FILE, INT_SITE_FILE, RUN_COLLECT_PY))
os.system("python tester/pilot.py %s" % (AD_FILE))
os.system("python tester/test.py %s" % (AD_FILE))